...
public final class MessagesConfig {
    ...
    private static final Map<String, Map<String, String>> STALE_DEFAULTS = Map.of(
            "en", Map.ofEntries(
                    ...
                    Map.entry("quest.guide-no-active-quest", "<#F69B45><b>●</b></#F69B45>  <gray>No active quest</gray>"),
                    Map.entry("quest.guide-progress-header", "<#F69B45><b>●</b></#F69B45>  <white>Quest progress:</white>"),
                    Map.entry("quest.gui-lore-guide-hint", "<dark_gray>Click to see every quest.</dark_gray>"),
